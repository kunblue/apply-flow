      ...
      <Card className="relative z-10 w-full max-w-md overflow-hidden rounded-2xl border border-white/70 bg-white/90 shadow-xl ring-1 ring-slate-950/[0.04] backdrop-blur-xl">
        ...
        <CardContent>
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <Button type="submit" disabled={isSubmitting} className="h-11 w-full bg-gradient-to-b from-sky-500 to-sky-600 text-white shadow-md shadow-sky-500/25 transition hover:from-sky-400 hover:to-sky-500">
